...
<div
	class="relative bg-white p-4 dark:text-gray-200 dark:bg-dark-card dark:border dark:border-dark-border"
>
	<div class="mb-4">
		<div class="flex flex-col-reverse sm:flex-row mb-3 items-start space-x-1">
			<div class="flex items-center space-x-1 flex-wrap">
				<a
					...
					class="cursor-pointer text-sm flex items-center hover:underline flex-wrap"
				>
					<img
						src={post.user.avatar_icon}
						alt=""
						width="20px"
						height="20px"
						class="w-8 h-8 rounded-full mr-2 block"
					/>
			...
			<div class="grow flex items-center space-x-1 w-full sm:w-auto">
				<div class="grow" />
				<button
					class="block rounded-full hover:shadow-sm transition-all text-lg text-gray-600 dark:text-gray-300 cursor-pointer p-relative p-2 hover:bg-gray-50 dark:hover:bg-gray-700"
				>
		...
		<div class="flex grow items-center flex-wrap w-[calc(100%-40px)]">
			...
			<div class="flex items-center">
				<div class="<%= indicator_class %>">
					<span class="i-lucide-server mr-1" />
				</div>
				<div class="<%= indicator_class %>">
